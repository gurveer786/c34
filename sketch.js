...
boggie7=new Boggie(650,170,50,50);
...
function draw() {
  ...
  chain5.show();
  chain6.show();  
;  var collision = Matter.SAT.collides(boggie7.body,rock1.body);
  ...
  function keyPressed()
  {
    if(keyCode === LIFT_ARROW){
      Matter.Body.applyForce(boggie7.body,{x:boggie6.body.position.x,y:boggie6.body.position.y},
        {x:0.5,y:0});
        trainSound.play();
    }
